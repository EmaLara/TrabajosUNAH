...
class Game():
    ...
    def __init__(self, player, alien_group, player_bullet_group, alien_bullet_group):
        ...
        #Set font
        self.font = pygame.font.Font("Triforce.ttf", 32)
    ...
    def draw(self):
        ...
        #Set text
        score_text = self.font.render("Puntaje: " + str(self.score), True, WHITE)
    ...
    def shift_aliens(self):
        ...
        if shift:
            ...
            if breach:
                ...
                self.player.lives -= 1
                self.check_game_status("¡Los Aliens han llegado a la linea!", "Presiona 'Enter' para continuar")
    ...
    def check_collisions(self):
        ...
        if pygame.sprite.spritecollide(self.player, self.alien_bullet_group, True):
            ...
            self.check_game_status("¡Has sido impactado!", "Presiona 'Enter' Para Continuar")
    ...
    def start_new_round(self):
        ...
        self.pause_game("Space Invaders Ronda " + str(self.round_number), "Presiona 'Enter' para empezar")
    ...
    def reset_game(self):
        """Reset the game"""
        self.pause_game("Puntaje Final: " + str(self.score), "Presiona 'Enter' para jugar de nuevo")
